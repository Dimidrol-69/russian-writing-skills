---
name: humanizer-ru
description: "Убирает признаки ИИ-генерации из русского блогового и постового текста, сохраняя живой, читаемый и нейтральный авторский голос. Использовать, когда Codex нужно переписать русскую статью, пост для Telegram, текст для vc.ru, Хабра, заметку, разбор или эссе, которые звучат слишком шаблонно, сухо, менторски, по-LinkedIn или как ChatGPT. Триггеры: сделай менее ИИ-шно, перепиши живее, звучит как ChatGPT, слишком сухо, шаблонно, выглядит как LinkedIn-пост. Не использовать для академических, юридических, greentext и коротких reply-текстов."
---
